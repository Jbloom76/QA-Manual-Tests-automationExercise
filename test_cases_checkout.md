...
| TC017        | Invalid payment details           | 1. Add item to card. <br> 2. Try to check out using invalid payment details.                              | Uder is notified that the payment details are invalid and prompted to re-enter. | Fail |
